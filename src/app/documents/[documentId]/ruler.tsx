...
export const Ruler=()=>{
    ...
    return(
        <div
        ref={rulerRef} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp} className="w-204 mx-auto h-6 border-b border-gray-300 flex items-end relative select-none print:hidden">
